...
class State:
    def __init__(self, state, final=False, formatter=None, shape='circle'):
        self.state = state
        self.final = final
        self.transitions = {}
    ...
    def to_deterministic(self, formatter=None):
    ...
    def graph(self,rankdir_conf='LR'):
        G = pydot.Dot(rankdir=rankdir_conf, margin=0.1)
