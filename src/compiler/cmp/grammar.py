...
objectid, typeid, num, stringx, boolx, new = G.Terminals('objectid typeid int string bool new')
...
def_class %= classx + objectid + ocur + feature_list + ccur + semi, lambda h,s: ClassDeclarationNode(s[2], s[4])
def_class %= classx + objectid + inherits + objectid + ocur + feature_list + ccur + semi, lambda h,s: ClassDeclarationNode(s[2], s[6], s[4])
...
def_attr %= typeid + colon + objectid + semi, lambda h,s: AttrDeclarationNode(s[1], s[3])
def_attr %= typeid + colon + objectid + larrow + expr + semi, lambda h,s: AttrDeclarationNode(s[1], s[3], s[5])

def_func %= typeid + opar + cpar + colon + objectid + ocur + expr + ccur + semi, lambda h,s: FuncDeclarationNode(s[1], [], s[5], s[7])
def_func %= typeid + opar + param_list + cpar + colon + objectid + ocur + expr + ccur + semi, lambda h,s: FuncDeclarationNode(s[1], s[3], s[6], s[8])

param_list %= param, lambda h,s: [s[1]]
param_list %= param + comma + param_list, lambda h,s: [s[1]] + s[3]
param %= typeid + colon + objectid, lambda h,s: (s[1], s[3])
...
atom %= typeid, lambda h,s: VariableNode(s[1])
atom %= new + objectid, lambda h,s: InstantiateNode(s[2])

func_call %= typeid + opar + arg_list + cpar, lambda h,s: CallNode(VariableNode('self'), s[1], s[3])
func_call %= factor + dot + typeid + opar + arg_list + cpar, lambda h,s: CallNode(s[1], s[3], s[5])
func_call %= factor + at + objectid + dot + typeid + opar + arg_list + cpar, lambda h,s: CallNode(s[1], s[5], s[7], s[3])
...
branch %= typeid + colon + objectid + rarrow + expr + semi, lambda h,s: (s[1], s[3], s[5])
...
iden %= typeid + colon + objectid, lambda h,s: (s[1], s[3], None)
iden %= typeid + colon + objectid + larrow + expr, lambda h,s: (s[1], s[3], s[5])

assign_def %= typeid + larrow + expr, lambda h,s: AssignNode(s[1], s[3])