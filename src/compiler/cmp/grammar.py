...
typeid, objectid, num, stringx, boolx, new = G.Terminals('typeid objectid int string bool new')
...
def_class %= classx + typeid + ocur + feature_list + ccur + semi, lambda h,s: ClassDeclarationNode(s[2], s[4])
def_class %= classx + typeid + inherits + typeid + ocur + feature_list + ccur + semi, lambda h,s: ClassDeclarationNode(s[2], s[6], s[4])
...
def_attr %= objectid + colon + typeid + semi, lambda h,s: AttrDeclarationNode(s[1], s[3])
def_attr %= objectid + colon + typeid + larrow + expr + semi, lambda h,s: AttrDeclarationNode(s[1], s[3], s[5])

def_func %= objectid + opar + cpar + colon + typeid + ocur + expr + ccur + semi, lambda h,s: FuncDeclarationNode(s[1], [], s[5], s[7])
def_func %= objectid + opar + param_list + cpar + colon + typeid + ocur + expr + ccur + semi, lambda h,s: FuncDeclarationNode(s[1], s[3], s[6], s[8])
...
func_call %= objectid + opar + arg_list + cpar, lambda h,s: CallNode(VariableNode('self'), s[1], s[3])
func_call %= factor + dot + objectid + opar + arg_list + cpar, lambda h,s: CallNode(s[1], s[3], s[5])
func_call %= factor + at + typeid + dot + objectid + opar + arg_list + cpar, lambda h,s: CallNode(s[1], s[5], s[7], s[3])
...
branch %= objectid + colon + typeid + rarrow + expr + semi, lambda h,s: (s[1], s[3], s[5])
