from app.lexer.errors import LexicographicError
from app.lexer.base import BaseLexer, find_column
from app.lexer.block_comments import BlockCommentLexer
from app.lexer.strings import StringsLexer


class CoolToken(object):
    @staticmethod
    def build_from(token, columnno):
...
class CoolLexer(BaseLexer):
    ...
    def tokenize(self, text: str, lineno=1, index=0):
        tokens = [
            CoolToken.build_from(t, find_column(text, t.index))
