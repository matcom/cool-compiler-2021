...
####################################################################
class Program(Node):
    def __init__(self, class_list, class_name_list) -> None:
        self.class_list = class_list
        self.names_list = class_name_list
    
class CoolClass(Node):
    def __init__(self, name, parent, feature_list) -> None:
        self.name = name
        self.parent = parent
...
class Case(Statement):
    def __init__(self, case_list, expr) -> None:
