...
_lr_productions = [
  ...
  ('def_class -> CLASS TYPE LPAREN feature_list RPAREN','def_class',5,'p_def_class','parser.py',40),
  ('def_class -> CLASS TYPE INHERITS TYPE LPAREN feature_list RPAREN','def_class',7,'p_def_class','parser.py',41),
