...
_lr_productions = [
  ...
  ('epsilon -> <empty>','epsilon',0,'p_epsilon','parser.py',43),
  ('class_list -> def_class SEMICOLON class_list','class_list',3,'p_class_list','parser.py',47),
  ('class_list -> def_class SEMICOLON','class_list',2,'p_class_list','parser.py',48),
  ('def_class -> CLASS TYPE LBRACE feature_list RBRACE','def_class',5,'p_def_class','parser.py',52),
  ('def_class -> CLASS TYPE INHERITS TYPE LBRACE feature_list RBRACE','def_class',7,'p_def_class','parser.py',53),
  ('feature_list -> def_attr SEMICOLON feature_list','feature_list',3,'p_feature_list','parser.py',60),
  ('feature_list -> def_func SEMICOLON feature_list','feature_list',3,'p_feature_list','parser.py',61),
  ('feature_list -> epsilon','feature_list',1,'p_feature_list','parser.py',62),
  ('def_attr -> ID COLON TYPE','def_attr',3,'p_def_attr','parser.py',66),
  ('def_attr -> ID COLON TYPE ASSIGN expr','def_attr',5,'p_def_attr','parser.py',67),
  ('def_func -> ID LPAREN params RPAREN COLON TYPE LBRACE expr RBRACE','def_func',9,'p_def_func','parser.py',74),
  ('params -> param_list','params',1,'p_params','parser.py',78),
  ('params -> param_list_empty','params',1,'p_params','parser.py',79),
  ...
  ('param_list_empty -> epsilon','param_list_empty',1,'p_param_list_empty','parser.py',88),
  ('param -> ID COLON TYPE','param',3,'p_param','parser.py',92),
  ('expr -> LET let_attrs IN expr','expr',4,'p_expr_flow','parser.py',96),
  ('expr -> CASE expr OF case_list ESAC','expr',5,'p_expr_flow','parser.py',97),
  ('expr -> IF expr THEN expr ELSE expr FI','expr',7,'p_expr_flow','parser.py',98),
  ('expr -> WHILE expr LOOP expr POOL','expr',5,'p_expr_flow','parser.py',99),
  ('expr -> ID ASSIGN expr','expr',3,'p_expr_assign','parser.py',111),
  ('expr -> expr AT TYPE DOT ID LPAREN args RPAREN','expr',8,'p_expr_func_call','parser.py',115),
  ('expr -> expr DOT ID LPAREN args RPAREN','expr',6,'p_expr_func_call','parser.py',116),
  ('expr -> ID LPAREN args RPAREN','expr',4,'p_expr_func_call','parser.py',117),
  ('expr -> expr PLUS expr','expr',3,'p_expr_operators_binary','parser.py',134),
  ('expr -> expr MINUS expr','expr',3,'p_expr_operators_binary','parser.py',135),
  ('expr -> expr STAR expr','expr',3,'p_expr_operators_binary','parser.py',136),
  ('expr -> expr DIV expr','expr',3,'p_expr_operators_binary','parser.py',137),
  ('expr -> expr LESS expr','expr',3,'p_expr_operators_binary','parser.py',138),
  ('expr -> expr LESSEQ expr','expr',3,'p_expr_operators_binary','parser.py',139),
  ('expr -> expr EQUAL expr','expr',3,'p_expr_operators_binary','parser.py',140),
  ('expr -> NOT expr','expr',2,'p_expr_operators_unary','parser.py',157),
  ('expr -> ISVOID expr','expr',2,'p_expr_operators_unary','parser.py',158),
  ('expr -> LNOT expr','expr',2,'p_expr_operators_unary','parser.py',159),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_expr_group','parser.py',168),
  ('expr -> atom','expr',1,'p_expr_atom','parser.py',172),
  ('let_attrs -> def_var','let_attrs',1,'p_let_attrs','parser.py',176),
  ('let_attrs -> def_var COMMA let_attrs','let_attrs',3,'p_let_attrs','parser.py',177),
  ('def_var -> ID COLON TYPE','def_var',3,'p_def_var','parser.py',181),
  ('def_var -> ID COLON TYPE ASSIGN expr','def_var',5,'p_def_var','parser.py',182),
  ('case_list -> case_option SEMICOLON','case_list',2,'p_case_list','parser.py',189),
  ('case_list -> case_option SEMICOLON case_list','case_list',3,'p_case_list','parser.py',190),
  ('case_option -> ID COLON TYPE ARROW expr','case_option',5,'p_case_option','parser.py',194),
  ('args -> arg_list','args',1,'p_args','parser.py',198),
  ('args -> arg_list_empty','args',1,'p_args','parser.py',199),
  ('arg_list -> expr','arg_list',1,'p_arg_list','parser.py',203),
  ('arg_list -> expr COMMA arg_list','arg_list',3,'p_arg_list','parser.py',204),
  ('arg_list_empty -> epsilon','arg_list_empty',1,'p_arg_list_empty','parser.py',208),
  ('atom -> INT','atom',1,'p_atom_int','parser.py',212),
  ('atom -> ID','atom',1,'p_atom_id','parser.py',216),
  ('atom -> TRUE','atom',1,'p_atom_bool','parser.py',220),
  ('atom -> FALSE','atom',1,'p_atom_bool','parser.py',221),
  ('atom -> STRING','atom',1,'p_atom_string','parser.py',225),
  ('atom -> NEW TYPE','atom',2,'p_atom_new','parser.py',229),
  ('atom -> block','atom',1,'p_atom_block','parser.py',233),
  ('block -> LBRACE block_list RBRACE','block',3,'p_block','parser.py',237),
  ('block_list -> expr SEMICOLON','block_list',2,'p_block_list','parser.py',241),
  ('block_list -> expr SEMICOLON block_list','block_list',3,'p_block_list','parser.py',242),
]
