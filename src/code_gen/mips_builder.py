...
class MIPSBuilder:
    ...
    def generate_exception_messages(self):
        self.register_data(
            mips.DataTypeNode, ABORT_SIGNAL, ".asciiz", ['"Program execution aborted"']
        )
        self.register_data(
            mips.DataTypeNode,
            CASE_MISSMATCH,
        ...
        self.register_data(
            mips.DataTypeNode, DISPATCH_VOID, ".asciiz", ['"Dispatch on void"']
        )
        self.register_data(
            mips.DataTypeNode, ZERO_DIVISION, ".asciiz", ['"Division by zero"']
        )
        self.register_data(
            mips.DataTypeNode, SUBSTR_OUT_RANGE, ".asciiz", ['"Substring out of range"']
        )
        self.register_data(
            mips.DataTypeNode, HEAP_OVERFLOW, ".asciiz", ['"Heap overflow"']
        )
    ...
    def visit(self, node):
        ...
        self.register_data(
            mips.DataTypeNode, f"{node.name}_cname", ".asciiz", [f'"{node.name}"']
        )
    ...
    def visit(self, node):
        ...
        self.register_instruction(
            mips.LoadWordNode, fp, OLD_FP_OFFSET, fp
        )  # stored (old)$fp
