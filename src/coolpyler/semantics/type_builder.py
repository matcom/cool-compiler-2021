from coolpyler.semantics.tools.type import Type
...
from coolpyler.semantics.tools.errors import SemanticError
from coolpyler.semantics.tools import TypeBag, Context
...
class TypeBuilder:
    ...
    def visit(self, node: CoolProgramNode):
    ...
    def visit(self, node: CoolClassNode):
    ...
    def visit(self, node: CoolAttrDeclNode):
        try:
    ...
    def visit(self, node: CoolMethodDeclNode):
        try:
