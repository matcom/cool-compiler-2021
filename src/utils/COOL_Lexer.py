...
class Lexer: 
    ...
    def tokenize(self,text):    
        while len(text) > 0:
            ...
            if error_token:
                self.errors.append(f'({self.line}, {self.column + 1}) - LexicographicError: ERROR "{error_token}"')
            ...
            # COMMENTS
                ...
                while len(text) > 0:
                    ...
                    self.errors.append(f'({self.line}, {self.column + 1}) - LexicographicError: EOF in comment')
            ...
            # STRINGS
                ...
                while len(text) > 0:
                    ...
                    if c == '\\':
                        ...
                        self.errors.append(f'({self.line}, {self.column}) - LexicographicError: Unterminated string constant')
                        self.line += 1
                        self.column = 0
                        break
                    
                    elif c == '\0':
                        self.errors.append(f'({self.line}, {self.column}) - LexicographicError: String contains null character')
