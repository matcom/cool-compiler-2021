...
class BasicXCool:
    ...
    def firsts(self):
        ...
        return {
            ...
            Sentence(G["T"], G["X"]): ContainerSet(
                G["num"], G["("], contains_epsilon=False
            ),
            Sentence(G["+"], G["T"], G["X"]): ContainerSet(
                G["+"], contains_epsilon=False
            ),
            Sentence(G["-"], G["T"], G["X"]): ContainerSet(
                G["-"], contains_epsilon=False
            ),
            G.Epsilon: ContainerSet(contains_epsilon=True),
            Sentence(G["F"], G["Y"]): ContainerSet(
                G["num"], G["("], contains_epsilon=False
            ),
            Sentence(G["*"], G["F"], G["Y"]): ContainerSet(
                G["*"], contains_epsilon=False
            ),
            Sentence(G["/"], G["F"], G["Y"]): ContainerSet(
                G["/"], contains_epsilon=False
    ...
    def follows(self):
        ...
        return {
            ...
            G["F"]: ContainerSet(
                G["-"], G.EOF, G["*"], G["/"], G[")"], G["+"], contains_epsilon=False
            ),
...
class PowXCool:
    ...
    def follows(self):
        ...
        return {
            ...
            G["T"]: ContainerSet(G["-"], G[")"], G.EOF, G["+"], contains_epsilon=False),
            G["F"]: ContainerSet(
                G["-"], G["*"], G["/"], G[")"], G.EOF, G["+"], contains_epsilon=False
            ),
            G["A"]: ContainerSet(
                G["-"],
                G["*"],
...
class Regex:
    ...
    def firsts(self):
        ...
        return {
            ...
            G["Z"]: ContainerSet(G["*"], contains_epsilon=True),
            Sentence(G["T"], G["X"]): ContainerSet(
                G["symbol"], G["("], contains_epsilon=False
            ),
    ...
    def follows(self):
        ...
        return {
            ...
            G["F"]: ContainerSet(
                G["symbol"], G["|"], G["("], G[")"], G.EOF, contains_epsilon=False
            ),
            G["A"]: ContainerSet(
                G["symbol"],
                G.EOF,
            ...
            G["Z"]: ContainerSet(
                G["symbol"], G.EOF, G["|"], G["("], G[")"], contains_epsilon=False
            ),
        }
